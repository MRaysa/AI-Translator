...
![AI Translator home](docs/screenshots/home.png)

_More captures and a 20–30s demo GIF can be added to [`docs/screenshots/`](docs/screenshots/) — see the [capture guide](docs/screenshots/README.md)._
